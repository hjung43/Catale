...
export default function StoreDetailPage(selectedStore) {
  // 봉명동과 궁동의 데이터를 병합합니다.
    ...
    <>
      <Container>
        <div className={styles.storeInfo}>
          ...
          <Storepicture storenumber={selectedStore.selectedStore.number} />
          <Storemenu storenumber={selectedStore.selectedStore.number} />
        </div>
      </Container>
    </>
  );
